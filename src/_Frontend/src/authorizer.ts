...
export class Authorizer {
    private static readonly clientId = "53a8c1f5-9183-4fc2-946c-819c24aaacc2";
    private static readonly authority = "https://login.microsoftonline.com/ca1ae43e-97d5-4f29-948d-793a5111abb1";
    private static readonly scopes = [
        "api://53a8c1f5-9183-4fc2-946c-819c24aaacc2/access_as_user",
        "user.read",
        "user.readbasic.all",
    ];
