    ...
    <el-container :class="$style.page">
        <el-header :class="$style.header">
            <div style="display:flex; align-items:center; gap:10px">
                <el-button link size="large" :icon="showMenu ? Expand : Fold" @click="showMenu = showMenu ? false : true" style="color:black;" />
        ...
        <el-container style="height: 100%; padding-top: 60px; box-sizing: border-box;">
            <el-aside style="height: 100%" :width="showMenu ? 'auto' : '15%'">
                <el-scrollbar style="height: 100%" view-style="height:100%">
                    <el-menu router :defaultOpeneds="['1', '3']" :default-active="router.currentRoute.value.path.slice(1)" :collapse="showMenu" style="height: 100%" >
                        <el-sub-menu index="1">
                            <template #title>
                                <el-icon><money /></el-icon>
                                <span>経費精算</span>
                            </template>
                            <el-menu-item index="TraveringExpense">旅費・交通費</el-menu-item>
                            <el-menu-item index="SundryExpense">諸経費</el-menu-item>
                        </el-sub-menu>
                        <el-menu-item v-if="isAdmin" index="ApproveHistory">
                            <template #title>
                        ...
                        <el-sub-menu v-if="isAdmin" index="3">
                            ...
                            <el-menu-item index="UserSetting">ユーザー</el-menu-item>
                            <el-menu-item index="CategorySetting">交通区分</el-menu-item>
                            <el-menu-item index="ExpenseTypeSetting">経費種別</el-menu-item>
                            <el-menu-item index="SystemSetting">システム設定</el-menu-item>
                        </el-sub-menu>
                    </el-menu>
                </el-scrollbar>
            </el-aside>
...
import { ElContainer, ElHeader, ElAside, ElMenu, ElSubMenu, ElIcon, ElMenuItem, ElMain, ElScrollbar, ElButton, ElSwitch } from "element-plus";
