...
const props = defineProps<{ modelValue: Omit<ExpenseType, "id"> }>();
const emit = defineEmits<{ (event: "update:model-value", user: Omit<ExpenseType, "id">): void }>();

const formRef = ref<FormInstance>();
const formValue = reactive<Omit<ExpenseType, "id">>(props.modelValue);
